...
Use this script: [https://github.com/devilr33f/knotocnho-patcher](https://github.com/devilr33f/knotocnho-patcher), I'm too lazy to explain.

### Bypass Method #2 (created by me):
I managed to quickly find the exact location of key validation check:
...
Option 2. Patch the binary by changing bytes at offset `0xF3324` from `1F050071` to `1F010071`.
